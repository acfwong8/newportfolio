...
function portfolioItems(iterations){
    for (var i = 1; i <= iterations; i++){
        ...
        $('#portfolio .item' + portItem).removeClass('shrunk' + i);
        $('#portfolio .item' + portItem).addClass('expand' + i);
        $(".portButton").removeClass("hidebutton");
        $(".portButton").addClass("showbutton");
    }
}
...
function portfolioStatic(iterations){
    for (var i = 1; i <= iterations; i++){
        ...
        $('#portfolio .item' + portItem).addClass('shrunk' + i);
        $('#portfolio .item' + portItem).removeClass('expand' + i);
        $(".portButton").addClass("hidebutton");
        $(".portButton").removeClass("showbutton");
    }
}
var currentPort = 2;
